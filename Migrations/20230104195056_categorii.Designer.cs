...
namespace Proiect.Migrations
{
    ...
    [Migration("20230104195056_categorii")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proiect.Models.PrezHotel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PrezID")
                        .HasColumnType("int");

                    b.Property<int?>("PrezentareId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proiect.Models.PrezHotel", b =>
                {
                    b.HasOne("Proiect.Models.Hotel", "Hotel")
                        .WithMany("PrezHoteluri")
                        .HasForeignKey("HotelID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Proiect.Models.Prezentare", "Prezentare")
                        .WithMany("PrezHoteluri")
                        .HasForeignKey("PrezentareId");

                    b.Navigation("Hotel");

                    b.Navigation("Prezentare");
                });
